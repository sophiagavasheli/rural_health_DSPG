...
ruca13 = read_excel(here("data", "source", "RUCA", "rucc2013.xls"))
ruca23 = read_excel(here("data", "source", "RUCA", "rucc2023.xlsx"))
...
write.csv(clean13, here("data", "outcome", "RUCA", "clean_rucc_2013.csv"), row.names = FALSE)

write.csv(clean23, here("data", "outcome", "RUCA", "clean_rucc_2023.csv"), row.names = FALSE)