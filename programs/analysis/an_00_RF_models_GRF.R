...
stroke_dth <- rf_model(dat,2010,2021,"CDCA_STROKE_DTH_RATE_ABOVE35", dir="all_params_tuned_plus_year_effects")

self_harm_dth <- rf_model(dat,2010,2023,"CDCW_SELFHARM_DTH_RATE", dir="all_params_tuned_plus_year_effects")

injury_dth <- rf_model(dat,2010,2023,"CDCW_INJURY_DTH_RATE", dir="all_params_tuned_plus_year_effects")

obesity <- rf_model(dat,2010,2017,"CHR_PCT_ADULT_OBESITY", dir="all_params_tuned_plus_year_effects")

low_birth <- rf_model(dat,2010,2014,"CHR_PCT_LOW_BIRTH_WT", dir="all_params_tuned_plus_year_effects")

mental <- rf_model(dat,2014,2022,"CHR_PCT_MENTAL_DISTRESS", dir="all_params_tuned_plus_year_effects")
